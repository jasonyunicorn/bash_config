...
#   Instead of appending to the $PATH variable like the example above,
#   add the path to the /private/etc/paths file
...
alias la='ls -FG1Ahp'                       # Preferred 'ls -a' implementation
